...
module Computer_System_mm_interconnect_0 (
		...
		output wire [0:0]  Servo_Control_servo_control_slave_address,                 //                   Servo_Control_servo_control_slave.address
		output wire        Servo_Control_servo_control_slave_write,                   //                                                    .write
		output wire        Servo_Control_servo_control_slave_read,                    //                                                    .read
		input  wire [15:0] Servo_Control_servo_control_slave_readdata,                //                                                    .readdata
		output wire [15:0] Servo_Control_servo_control_slave_writedata,               //                                                    .writedata
		output wire [1:0]  Servo_Control_servo_control_slave_byteenable,              //                                                    .byteenable
	...
	wire   [17:0] cmd_mux_src_channel;                                                           // cmd_mux:src_channel -> ADC_adc_slave_agent:cp_channel
	...
	wire   [17:0] cmd_mux_003_src_channel;                                                       // cmd_mux_003:src_channel -> Nios2_debug_mem_slave_agent:cp_channel
	...
	wire   [17:0] cmd_mux_005_src_channel;                                                       // cmd_mux_005:src_channel -> Onchip_SRAM_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_006_src_channel;                                                       // cmd_mux_006:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_007_src_channel;                                                       // cmd_mux_007:src_channel -> HEX3_HEX0_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_008_src_channel;                                                       // cmd_mux_008:src_channel -> HEX5_HEX4_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_009_src_channel;                                                       // cmd_mux_009:src_channel -> Slider_Switches_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_010_src_channel;                                                       // cmd_mux_010:src_channel -> Pushbuttons_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_011_src_channel;                                                       // cmd_mux_011:src_channel -> Expansion_JP1_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_012_src_channel;                                                       // cmd_mux_012:src_channel -> Arduino_GPIO_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_013_src_channel;                                                       // cmd_mux_013:src_channel -> Arduino_Reset_N_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_014_src_channel;                                                       // cmd_mux_014:src_channel -> Interval_Timer_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_015_src_channel;                                                       // cmd_mux_015:src_channel -> Interval_Timer_2_s1_agent:cp_channel
	...
	wire   [15:0] servo_control_servo_control_slave_agent_m0_readdata;                           // Servo_Control_servo_control_slave_translator:uav_readdata -> Servo_Control_servo_control_slave_agent:m0_readdata
	wire          servo_control_servo_control_slave_agent_m0_waitrequest;                        // Servo_Control_servo_control_slave_translator:uav_waitrequest -> Servo_Control_servo_control_slave_agent:m0_waitrequest
	wire          servo_control_servo_control_slave_agent_m0_debugaccess;                        // Servo_Control_servo_control_slave_agent:m0_debugaccess -> Servo_Control_servo_control_slave_translator:uav_debugaccess
	wire   [31:0] servo_control_servo_control_slave_agent_m0_address;                            // Servo_Control_servo_control_slave_agent:m0_address -> Servo_Control_servo_control_slave_translator:uav_address
	wire    [1:0] servo_control_servo_control_slave_agent_m0_byteenable;                         // Servo_Control_servo_control_slave_agent:m0_byteenable -> Servo_Control_servo_control_slave_translator:uav_byteenable
	wire          servo_control_servo_control_slave_agent_m0_read;                               // Servo_Control_servo_control_slave_agent:m0_read -> Servo_Control_servo_control_slave_translator:uav_read
	wire          servo_control_servo_control_slave_agent_m0_readdatavalid;                      // Servo_Control_servo_control_slave_translator:uav_readdatavalid -> Servo_Control_servo_control_slave_agent:m0_readdatavalid
	wire          servo_control_servo_control_slave_agent_m0_lock;                               // Servo_Control_servo_control_slave_agent:m0_lock -> Servo_Control_servo_control_slave_translator:uav_lock
	wire   [15:0] servo_control_servo_control_slave_agent_m0_writedata;                          // Servo_Control_servo_control_slave_agent:m0_writedata -> Servo_Control_servo_control_slave_translator:uav_writedata
	wire          servo_control_servo_control_slave_agent_m0_write;                              // Servo_Control_servo_control_slave_agent:m0_write -> Servo_Control_servo_control_slave_translator:uav_write
	wire    [1:0] servo_control_servo_control_slave_agent_m0_burstcount;                         // Servo_Control_servo_control_slave_agent:m0_burstcount -> Servo_Control_servo_control_slave_translator:uav_burstcount
	wire          servo_control_servo_control_slave_agent_rf_source_valid;                       // Servo_Control_servo_control_slave_agent:rf_source_valid -> Servo_Control_servo_control_slave_agent_rsp_fifo:in_valid
	wire   [94:0] servo_control_servo_control_slave_agent_rf_source_data;                        // Servo_Control_servo_control_slave_agent:rf_source_data -> Servo_Control_servo_control_slave_agent_rsp_fifo:in_data
	wire          servo_control_servo_control_slave_agent_rf_source_ready;                       // Servo_Control_servo_control_slave_agent_rsp_fifo:in_ready -> Servo_Control_servo_control_slave_agent:rf_source_ready
	wire          servo_control_servo_control_slave_agent_rf_source_startofpacket;               // Servo_Control_servo_control_slave_agent:rf_source_startofpacket -> Servo_Control_servo_control_slave_agent_rsp_fifo:in_startofpacket
	wire          servo_control_servo_control_slave_agent_rf_source_endofpacket;                 // Servo_Control_servo_control_slave_agent:rf_source_endofpacket -> Servo_Control_servo_control_slave_agent_rsp_fifo:in_endofpacket
	wire          servo_control_servo_control_slave_agent_rsp_fifo_out_valid;                    // Servo_Control_servo_control_slave_agent_rsp_fifo:out_valid -> Servo_Control_servo_control_slave_agent:rf_sink_valid
	wire   [94:0] servo_control_servo_control_slave_agent_rsp_fifo_out_data;                     // Servo_Control_servo_control_slave_agent_rsp_fifo:out_data -> Servo_Control_servo_control_slave_agent:rf_sink_data
	wire          servo_control_servo_control_slave_agent_rsp_fifo_out_ready;                    // Servo_Control_servo_control_slave_agent:rf_sink_ready -> Servo_Control_servo_control_slave_agent_rsp_fifo:out_ready
	wire          servo_control_servo_control_slave_agent_rsp_fifo_out_startofpacket;            // Servo_Control_servo_control_slave_agent_rsp_fifo:out_startofpacket -> Servo_Control_servo_control_slave_agent:rf_sink_startofpacket
	wire          servo_control_servo_control_slave_agent_rsp_fifo_out_endofpacket;              // Servo_Control_servo_control_slave_agent_rsp_fifo:out_endofpacket -> Servo_Control_servo_control_slave_agent:rf_sink_endofpacket
	...
	wire          servo_control_servo_control_slave_agent_rp_valid;                              // Servo_Control_servo_control_slave_agent:rp_valid -> router_019:sink_valid
	wire   [93:0] servo_control_servo_control_slave_agent_rp_data;                               // Servo_Control_servo_control_slave_agent:rp_data -> router_019:sink_data
	wire          servo_control_servo_control_slave_agent_rp_ready;                              // router_019:sink_ready -> Servo_Control_servo_control_slave_agent:rp_ready
	wire          servo_control_servo_control_slave_agent_rp_startofpacket;                      // Servo_Control_servo_control_slave_agent:rp_startofpacket -> router_019:sink_startofpacket
	wire          servo_control_servo_control_slave_agent_rp_endofpacket;                        // Servo_Control_servo_control_slave_agent:rp_endofpacket -> router_019:sink_endofpacket
	wire          onchip_sram_s2_agent_rp_valid;                                                 // Onchip_SRAM_s2_agent:rp_valid -> router_020:sink_valid
	wire  [111:0] onchip_sram_s2_agent_rp_data;                                                  // Onchip_SRAM_s2_agent:rp_data -> router_020:sink_data
	wire          onchip_sram_s2_agent_rp_ready;                                                 // router_020:sink_ready -> Onchip_SRAM_s2_agent:rp_ready
	wire          onchip_sram_s2_agent_rp_startofpacket;                                         // Onchip_SRAM_s2_agent:rp_startofpacket -> router_020:sink_startofpacket
	wire          onchip_sram_s2_agent_rp_endofpacket;                                           // Onchip_SRAM_s2_agent:rp_endofpacket -> router_020:sink_endofpacket
	...
	wire          servo_control_servo_control_slave_burst_adapter_source0_valid;                 // Servo_Control_servo_control_slave_burst_adapter:source0_valid -> Servo_Control_servo_control_slave_agent:cp_valid
	wire   [93:0] servo_control_servo_control_slave_burst_adapter_source0_data;                  // Servo_Control_servo_control_slave_burst_adapter:source0_data -> Servo_Control_servo_control_slave_agent:cp_data
	wire          servo_control_servo_control_slave_burst_adapter_source0_ready;                 // Servo_Control_servo_control_slave_agent:cp_ready -> Servo_Control_servo_control_slave_burst_adapter:source0_ready
	wire   [17:0] servo_control_servo_control_slave_burst_adapter_source0_channel;               // Servo_Control_servo_control_slave_burst_adapter:source0_channel -> Servo_Control_servo_control_slave_agent:cp_channel
	wire          servo_control_servo_control_slave_burst_adapter_source0_startofpacket;         // Servo_Control_servo_control_slave_burst_adapter:source0_startofpacket -> Servo_Control_servo_control_slave_agent:cp_startofpacket
	wire          servo_control_servo_control_slave_burst_adapter_source0_endofpacket;           // Servo_Control_servo_control_slave_burst_adapter:source0_endofpacket -> Servo_Control_servo_control_slave_agent:cp_endofpacket
	...
	wire   [17:0] cmd_demux_002_src1_channel;                                                    // cmd_demux_002:src1_channel -> cmd_mux_004:sink2_channel
	...
	wire   [17:0] rsp_demux_004_src2_channel;                                                    // rsp_demux_004:src2_channel -> rsp_mux_002:sink1_channel
	...
	wire          router_019_src_valid;                                                          // router_019:src_valid -> Servo_Control_servo_control_slave_rsp_width_adapter:in_valid
	wire   [93:0] router_019_src_data;                                                           // router_019:src_data -> Servo_Control_servo_control_slave_rsp_width_adapter:in_data
	wire          router_019_src_ready;                                                          // Servo_Control_servo_control_slave_rsp_width_adapter:in_ready -> router_019:src_ready
	wire   [17:0] router_019_src_channel;                                                        // router_019:src_channel -> Servo_Control_servo_control_slave_rsp_width_adapter:in_channel
	wire          router_019_src_startofpacket;                                                  // router_019:src_startofpacket -> Servo_Control_servo_control_slave_rsp_width_adapter:in_startofpacket
	wire          router_019_src_endofpacket;                                                    // router_019:src_endofpacket -> Servo_Control_servo_control_slave_rsp_width_adapter:in_endofpacket
	wire          servo_control_servo_control_slave_rsp_width_adapter_src_valid;                 // Servo_Control_servo_control_slave_rsp_width_adapter:out_valid -> rsp_demux_016:sink_valid
	wire  [111:0] servo_control_servo_control_slave_rsp_width_adapter_src_data;                  // Servo_Control_servo_control_slave_rsp_width_adapter:out_data -> rsp_demux_016:sink_data
	wire          servo_control_servo_control_slave_rsp_width_adapter_src_ready;                 // rsp_demux_016:sink_ready -> Servo_Control_servo_control_slave_rsp_width_adapter:out_ready
	wire   [17:0] servo_control_servo_control_slave_rsp_width_adapter_src_channel;               // Servo_Control_servo_control_slave_rsp_width_adapter:out_channel -> rsp_demux_016:sink_channel
	wire          servo_control_servo_control_slave_rsp_width_adapter_src_startofpacket;         // Servo_Control_servo_control_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_016:sink_startofpacket
	wire          servo_control_servo_control_slave_rsp_width_adapter_src_endofpacket;           // Servo_Control_servo_control_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_016:sink_endofpacket
	...
	wire          cmd_mux_016_src_valid;                                                         // cmd_mux_016:src_valid -> Servo_Control_servo_control_slave_cmd_width_adapter:in_valid
	wire  [111:0] cmd_mux_016_src_data;                                                          // cmd_mux_016:src_data -> Servo_Control_servo_control_slave_cmd_width_adapter:in_data
	wire          cmd_mux_016_src_ready;                                                         // Servo_Control_servo_control_slave_cmd_width_adapter:in_ready -> cmd_mux_016:src_ready
	wire   [17:0] cmd_mux_016_src_channel;                                                       // cmd_mux_016:src_channel -> Servo_Control_servo_control_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_016_src_startofpacket;                                                 // cmd_mux_016:src_startofpacket -> Servo_Control_servo_control_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                   // cmd_mux_016:src_endofpacket -> Servo_Control_servo_control_slave_cmd_width_adapter:in_endofpacket
	wire          servo_control_servo_control_slave_cmd_width_adapter_src_valid;                 // Servo_Control_servo_control_slave_cmd_width_adapter:out_valid -> Servo_Control_servo_control_slave_burst_adapter:sink0_valid
	wire   [93:0] servo_control_servo_control_slave_cmd_width_adapter_src_data;                  // Servo_Control_servo_control_slave_cmd_width_adapter:out_data -> Servo_Control_servo_control_slave_burst_adapter:sink0_data
	wire          servo_control_servo_control_slave_cmd_width_adapter_src_ready;                 // Servo_Control_servo_control_slave_burst_adapter:sink0_ready -> Servo_Control_servo_control_slave_cmd_width_adapter:out_ready
	wire   [17:0] servo_control_servo_control_slave_cmd_width_adapter_src_channel;               // Servo_Control_servo_control_slave_cmd_width_adapter:out_channel -> Servo_Control_servo_control_slave_burst_adapter:sink0_channel
	wire          servo_control_servo_control_slave_cmd_width_adapter_src_startofpacket;         // Servo_Control_servo_control_slave_cmd_width_adapter:out_startofpacket -> Servo_Control_servo_control_slave_burst_adapter:sink0_startofpacket
	wire          servo_control_servo_control_slave_cmd_width_adapter_src_endofpacket;           // Servo_Control_servo_control_slave_cmd_width_adapter:out_endofpacket -> Servo_Control_servo_control_slave_burst_adapter:sink0_endofpacket
	...
	wire          servo_control_servo_control_slave_agent_rdata_fifo_src_valid;                  // Servo_Control_servo_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [17:0] servo_control_servo_control_slave_agent_rdata_fifo_src_data;                   // Servo_Control_servo_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          servo_control_servo_control_slave_agent_rdata_fifo_src_ready;                  // avalon_st_adapter_016:in_0_ready -> Servo_Control_servo_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_016_out_0_valid;                                             // avalon_st_adapter_016:out_0_valid -> Servo_Control_servo_control_slave_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_016_out_0_data;                                              // avalon_st_adapter_016:out_0_data -> Servo_Control_servo_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_016_out_0_ready;                                             // Servo_Control_servo_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_016:out_0_ready
	wire    [0:0] avalon_st_adapter_016_out_0_error;                                             // avalon_st_adapter_016:out_0_error -> Servo_Control_servo_control_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) servo_control_servo_control_slave_translator (
		.clk                    (System_PLL_sys_clk_clk),                                   //                      clk.clk
		.reset                  (ADC_reset_reset_bridge_in_reset_reset),                    //                    reset.reset
		.uav_address            (servo_control_servo_control_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (servo_control_servo_control_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (servo_control_servo_control_slave_agent_m0_read),          //                         .read
		.uav_write              (servo_control_servo_control_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (servo_control_servo_control_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (servo_control_servo_control_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (servo_control_servo_control_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (servo_control_servo_control_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (servo_control_servo_control_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (servo_control_servo_control_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (servo_control_servo_control_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (Servo_Control_servo_control_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (Servo_Control_servo_control_slave_write),                  //                         .write
		.av_read                (Servo_Control_servo_control_slave_read),                   //                         .read
		.av_readdata            (Servo_Control_servo_control_slave_readdata),               //                         .readdata
		.av_writedata           (Servo_Control_servo_control_slave_writedata),              //                         .writedata
		.av_byteenable          (Servo_Control_servo_control_slave_byteenable),             //                         .byteenable
		.av_begintransfer       (),                                                         //              (terminated)
		.av_beginbursttransfer  (),                                                         //              (terminated)
		.av_burstcount          (),                                                         //              (terminated)
		.av_readdatavalid       (1'b0),                                                     //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) servo_control_servo_control_slave_agent (
		.clk                     (System_PLL_sys_clk_clk),                                                //             clk.clk
		.reset                   (ADC_reset_reset_bridge_in_reset_reset),                                 //       clk_reset.reset
		.m0_address              (servo_control_servo_control_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (servo_control_servo_control_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (servo_control_servo_control_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (servo_control_servo_control_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (servo_control_servo_control_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (servo_control_servo_control_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (servo_control_servo_control_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (servo_control_servo_control_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (servo_control_servo_control_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (servo_control_servo_control_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (servo_control_servo_control_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (servo_control_servo_control_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (servo_control_servo_control_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (servo_control_servo_control_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (servo_control_servo_control_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (servo_control_servo_control_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (servo_control_servo_control_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (servo_control_servo_control_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (servo_control_servo_control_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (servo_control_servo_control_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (servo_control_servo_control_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (servo_control_servo_control_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (servo_control_servo_control_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (servo_control_servo_control_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (servo_control_servo_control_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (servo_control_servo_control_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (servo_control_servo_control_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (servo_control_servo_control_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (servo_control_servo_control_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (servo_control_servo_control_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (servo_control_servo_control_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (servo_control_servo_control_slave_agent_rf_source_data),                //                .data
		...
		.rdata_fifo_src_ready    (servo_control_servo_control_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (servo_control_servo_control_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (servo_control_servo_control_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                                 //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                   //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) servo_control_servo_control_slave_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                                             //       clk.clk
		.reset             (ADC_reset_reset_bridge_in_reset_reset),                              // clk_reset.reset
		.in_data           (servo_control_servo_control_slave_agent_rf_source_data),             //        in.data
		.in_valid          (servo_control_servo_control_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (servo_control_servo_control_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (servo_control_servo_control_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (servo_control_servo_control_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (servo_control_servo_control_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (servo_control_servo_control_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (servo_control_servo_control_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (servo_control_servo_control_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (servo_control_servo_control_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                              // (terminated)
		.csr_read          (1'b0),                                                               // (terminated)
		.csr_write         (1'b0),                                                               // (terminated)
		.csr_readdata      (),                                                                   // (terminated)
	...
	Computer_System_mm_interconnect_0_router_019 router_019 (
		.sink_ready         (servo_control_servo_control_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (servo_control_servo_control_slave_agent_rp_valid),         //          .valid
		.sink_data          (servo_control_servo_control_slave_agent_rp_data),          //          .data
		.sink_startofpacket (servo_control_servo_control_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (servo_control_servo_control_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                                   //       clk.clk
		.reset              (ADC_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.ADAPTER_VERSION           ("13.1")
	) servo_control_servo_control_slave_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                                //       cr0.clk
		.reset                 (ADC_reset_reset_bridge_in_reset_reset),                                 // cr0_reset.reset
		.sink0_valid           (servo_control_servo_control_slave_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (servo_control_servo_control_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (servo_control_servo_control_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (servo_control_servo_control_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (servo_control_servo_control_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (servo_control_servo_control_slave_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (servo_control_servo_control_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (servo_control_servo_control_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (servo_control_servo_control_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (servo_control_servo_control_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (servo_control_servo_control_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (servo_control_servo_control_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_0_rsp_demux rsp_demux_016 (
		.clk                (System_PLL_sys_clk_clk),                                                //       clk.clk
		.reset              (ADC_reset_reset_bridge_in_reset_reset),                                 // clk_reset.reset
		.sink_ready         (servo_control_servo_control_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (servo_control_servo_control_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (servo_control_servo_control_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (servo_control_servo_control_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (servo_control_servo_control_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (servo_control_servo_control_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	Computer_System_mm_interconnect_0_rsp_demux_017 rsp_demux_017 (
		.clk                (System_PLL_sys_clk_clk),                //       clk.clk
		.reset              (ADC_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) servo_control_servo_control_slave_rsp_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                                //       clk.clk
		.reset                (ADC_reset_reset_bridge_in_reset_reset),                                 // clk_reset.reset
		...
		.out_endofpacket      (servo_control_servo_control_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (servo_control_servo_control_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (servo_control_servo_control_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (servo_control_servo_control_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (servo_control_servo_control_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (servo_control_servo_control_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                 // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) servo_control_servo_control_slave_cmd_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                                //       clk.clk
		.reset                (ADC_reset_reset_bridge_in_reset_reset),                                 // clk_reset.reset
		...
		.out_endofpacket      (servo_control_servo_control_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (servo_control_servo_control_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (servo_control_servo_control_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (servo_control_servo_control_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (servo_control_servo_control_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (servo_control_servo_control_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                 // (terminated)
	);
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter_004 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (ADC_reset_reset_bridge_in_reset_reset),                        // in_rst_0.reset
		.in_0_data      (servo_control_servo_control_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (servo_control_servo_control_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (servo_control_servo_control_slave_agent_rdata_fifo_src_ready), //         .ready
