...
module Computer_System_mm_interconnect_0 (
		...
		output wire [1:0]  Servo_Control_s1_address,                                  //                                    Servo_Control_s1.address
		output wire        Servo_Control_s1_write,                                    //                                                    .write
		input  wire [31:0] Servo_Control_s1_readdata,                                 //                                                    .readdata
		output wire [31:0] Servo_Control_s1_writedata,                                //                                                    .writedata
		output wire        Servo_Control_s1_chipselect,                               //                                                    .chipselect
	...
	wire   [31:0] servo_control_s1_agent_m0_readdata;                                            // Servo_Control_s1_translator:uav_readdata -> Servo_Control_s1_agent:m0_readdata
	wire          servo_control_s1_agent_m0_waitrequest;                                         // Servo_Control_s1_translator:uav_waitrequest -> Servo_Control_s1_agent:m0_waitrequest
	wire          servo_control_s1_agent_m0_debugaccess;                                         // Servo_Control_s1_agent:m0_debugaccess -> Servo_Control_s1_translator:uav_debugaccess
	wire   [31:0] servo_control_s1_agent_m0_address;                                             // Servo_Control_s1_agent:m0_address -> Servo_Control_s1_translator:uav_address
	wire    [3:0] servo_control_s1_agent_m0_byteenable;                                          // Servo_Control_s1_agent:m0_byteenable -> Servo_Control_s1_translator:uav_byteenable
	wire          servo_control_s1_agent_m0_read;                                                // Servo_Control_s1_agent:m0_read -> Servo_Control_s1_translator:uav_read
	wire          servo_control_s1_agent_m0_readdatavalid;                                       // Servo_Control_s1_translator:uav_readdatavalid -> Servo_Control_s1_agent:m0_readdatavalid
	wire          servo_control_s1_agent_m0_lock;                                                // Servo_Control_s1_agent:m0_lock -> Servo_Control_s1_translator:uav_lock
	wire   [31:0] servo_control_s1_agent_m0_writedata;                                           // Servo_Control_s1_agent:m0_writedata -> Servo_Control_s1_translator:uav_writedata
	wire          servo_control_s1_agent_m0_write;                                               // Servo_Control_s1_agent:m0_write -> Servo_Control_s1_translator:uav_write
	wire    [2:0] servo_control_s1_agent_m0_burstcount;                                          // Servo_Control_s1_agent:m0_burstcount -> Servo_Control_s1_translator:uav_burstcount
	wire          servo_control_s1_agent_rf_source_valid;                                        // Servo_Control_s1_agent:rf_source_valid -> Servo_Control_s1_agent_rsp_fifo:in_valid
	wire  [112:0] servo_control_s1_agent_rf_source_data;                                         // Servo_Control_s1_agent:rf_source_data -> Servo_Control_s1_agent_rsp_fifo:in_data
	wire          servo_control_s1_agent_rf_source_ready;                                        // Servo_Control_s1_agent_rsp_fifo:in_ready -> Servo_Control_s1_agent:rf_source_ready
	wire          servo_control_s1_agent_rf_source_startofpacket;                                // Servo_Control_s1_agent:rf_source_startofpacket -> Servo_Control_s1_agent_rsp_fifo:in_startofpacket
	wire          servo_control_s1_agent_rf_source_endofpacket;                                  // Servo_Control_s1_agent:rf_source_endofpacket -> Servo_Control_s1_agent_rsp_fifo:in_endofpacket
	wire          servo_control_s1_agent_rsp_fifo_out_valid;                                     // Servo_Control_s1_agent_rsp_fifo:out_valid -> Servo_Control_s1_agent:rf_sink_valid
	wire  [112:0] servo_control_s1_agent_rsp_fifo_out_data;                                      // Servo_Control_s1_agent_rsp_fifo:out_data -> Servo_Control_s1_agent:rf_sink_data
	wire          servo_control_s1_agent_rsp_fifo_out_ready;                                     // Servo_Control_s1_agent:rf_sink_ready -> Servo_Control_s1_agent_rsp_fifo:out_ready
	wire          servo_control_s1_agent_rsp_fifo_out_startofpacket;                             // Servo_Control_s1_agent_rsp_fifo:out_startofpacket -> Servo_Control_s1_agent:rf_sink_startofpacket
	wire          servo_control_s1_agent_rsp_fifo_out_endofpacket;                               // Servo_Control_s1_agent_rsp_fifo:out_endofpacket -> Servo_Control_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_016_src_valid;                                                         // cmd_mux_016:src_valid -> Servo_Control_s1_agent:cp_valid
	wire  [111:0] cmd_mux_016_src_data;                                                          // cmd_mux_016:src_data -> Servo_Control_s1_agent:cp_data
	wire          cmd_mux_016_src_ready;                                                         // Servo_Control_s1_agent:cp_ready -> cmd_mux_016:src_ready
	wire   [17:0] cmd_mux_016_src_channel;                                                       // cmd_mux_016:src_channel -> Servo_Control_s1_agent:cp_channel
	wire          cmd_mux_016_src_startofpacket;                                                 // cmd_mux_016:src_startofpacket -> Servo_Control_s1_agent:cp_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                   // cmd_mux_016:src_endofpacket -> Servo_Control_s1_agent:cp_endofpacket
	...
	wire          servo_control_s1_agent_rp_valid;                                               // Servo_Control_s1_agent:rp_valid -> router_019:sink_valid
	wire  [111:0] servo_control_s1_agent_rp_data;                                                // Servo_Control_s1_agent:rp_data -> router_019:sink_data
	wire          servo_control_s1_agent_rp_ready;                                               // router_019:sink_ready -> Servo_Control_s1_agent:rp_ready
	wire          servo_control_s1_agent_rp_startofpacket;                                       // Servo_Control_s1_agent:rp_startofpacket -> router_019:sink_startofpacket
	wire          servo_control_s1_agent_rp_endofpacket;                                         // Servo_Control_s1_agent:rp_endofpacket -> router_019:sink_endofpacket
	...
	wire          servo_control_s1_agent_rdata_fifo_src_valid;                                   // Servo_Control_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [33:0] servo_control_s1_agent_rdata_fifo_src_data;                                    // Servo_Control_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          servo_control_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_016:in_0_ready -> Servo_Control_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_016_out_0_valid;                                             // avalon_st_adapter_016:out_0_valid -> Servo_Control_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_016_out_0_data;                                              // avalon_st_adapter_016:out_0_data -> Servo_Control_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_016_out_0_ready;                                             // Servo_Control_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_016:out_0_ready
	wire    [0:0] avalon_st_adapter_016_out_0_error;                                             // avalon_st_adapter_016:out_0_error -> Servo_Control_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) servo_control_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                  //                      clk.clk
		.reset                  (ADC_reset_reset_bridge_in_reset_reset),   //                    reset.reset
		.uav_address            (servo_control_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (servo_control_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (servo_control_s1_agent_m0_read),          //                         .read
		.uav_write              (servo_control_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (servo_control_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (servo_control_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (servo_control_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (servo_control_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (servo_control_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (servo_control_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (servo_control_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (Servo_Control_s1_address),                //      avalon_anti_slave_0.address
		.av_write               (Servo_Control_s1_write),                  //                         .write
		.av_readdata            (Servo_Control_s1_readdata),               //                         .readdata
		.av_writedata           (Servo_Control_s1_writedata),              //                         .writedata
		.av_chipselect          (Servo_Control_s1_chipselect),             //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) servo_control_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                            //             clk.clk
		.reset                   (ADC_reset_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (servo_control_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (servo_control_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (servo_control_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (servo_control_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (servo_control_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (servo_control_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (servo_control_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (servo_control_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (servo_control_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (servo_control_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (servo_control_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (servo_control_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (servo_control_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (servo_control_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (servo_control_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (servo_control_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (servo_control_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (servo_control_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (servo_control_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (servo_control_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (servo_control_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (servo_control_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (servo_control_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (servo_control_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (servo_control_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (servo_control_s1_agent_rf_source_data),             //                .data
		...
		.rdata_fifo_src_ready    (servo_control_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (servo_control_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (servo_control_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) servo_control_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                            //       clk.clk
		.reset             (ADC_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (servo_control_s1_agent_rf_source_data),             //        in.data
		.in_valid          (servo_control_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (servo_control_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (servo_control_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (servo_control_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (servo_control_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (servo_control_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (servo_control_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (servo_control_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (servo_control_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	Computer_System_mm_interconnect_0_router_003 router_019 (
		.sink_ready         (servo_control_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (servo_control_s1_agent_rp_valid),         //          .valid
		.sink_data          (servo_control_s1_agent_rp_data),          //          .data
		.sink_startofpacket (servo_control_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (servo_control_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                  //       clk.clk
		.reset              (ADC_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (ADC_reset_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (servo_control_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (servo_control_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (servo_control_s1_agent_rdata_fifo_src_ready), //         .ready
