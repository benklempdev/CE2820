...
module Computer_System_mm_interconnect_0 (
	...
	wire   [19:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> ADC_adc_slave_agent:cp_channel
	...
	wire   [19:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_channel
	...
	wire   [19:0] cmd_mux_003_src_channel;                                                        // cmd_mux_003:src_channel -> SysID_control_slave_agent:cp_channel
	...
	wire   [19:0] cmd_mux_004_src_channel;                                                        // cmd_mux_004:src_channel -> Nios2_debug_mem_slave_agent:cp_channel
	...
	wire   [19:0] cmd_mux_006_src_channel;                                                        // cmd_mux_006:src_channel -> Onchip_SRAM_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_008_src_channel;                                                        // cmd_mux_008:src_channel -> HEX3_HEX0_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_009_src_channel;                                                        // cmd_mux_009:src_channel -> HEX5_HEX4_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_010_src_channel;                                                        // cmd_mux_010:src_channel -> Slider_Switches_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_011_src_channel;                                                        // cmd_mux_011:src_channel -> Pushbuttons_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_012_src_channel;                                                        // cmd_mux_012:src_channel -> Expansion_JP1_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_013_src_channel;                                                        // cmd_mux_013:src_channel -> Arduino_GPIO_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_014_src_channel;                                                        // cmd_mux_014:src_channel -> Arduino_Reset_N_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_015_src_channel;                                                        // cmd_mux_015:src_channel -> Interval_Timer_s1_agent:cp_channel
	...
	wire   [19:0] cmd_mux_016_src_channel;                                                        // cmd_mux_016:src_channel -> Interval_Timer_2_s1_agent:cp_channel
	...
	wire   [19:0] cmd_demux_002_src0_channel;                                                     // cmd_demux_002:src0_channel -> cmd_mux_004:sink1_channel
	...
	wire   [19:0] cmd_demux_002_src1_channel;                                                     // cmd_demux_002:src1_channel -> cmd_mux_005:sink2_channel
	...
	wire   [19:0] rsp_demux_004_src1_channel;                                                     // rsp_demux_004:src1_channel -> rsp_mux_002:sink0_channel
	...
	wire   [19:0] rsp_demux_005_src2_channel;                                                     // rsp_demux_005:src2_channel -> rsp_mux_002:sink1_channel
	...
	wire          router_020_src_valid;                                                           // router_020:src_valid -> Servo0_servo_control_slave_rsp_width_adapter:in_valid
	wire   [93:0] router_020_src_data;                                                            // router_020:src_data -> Servo0_servo_control_slave_rsp_width_adapter:in_data
	wire          router_020_src_ready;                                                           // Servo0_servo_control_slave_rsp_width_adapter:in_ready -> router_020:src_ready
	wire   [19:0] router_020_src_channel;                                                         // router_020:src_channel -> Servo0_servo_control_slave_rsp_width_adapter:in_channel
	wire          router_020_src_startofpacket;                                                   // router_020:src_startofpacket -> Servo0_servo_control_slave_rsp_width_adapter:in_startofpacket
	wire          router_020_src_endofpacket;                                                     // router_020:src_endofpacket -> Servo0_servo_control_slave_rsp_width_adapter:in_endofpacket
	wire          servo0_servo_control_slave_rsp_width_adapter_src_valid;                         // Servo0_servo_control_slave_rsp_width_adapter:out_valid -> rsp_demux_017:sink_valid
	wire  [111:0] servo0_servo_control_slave_rsp_width_adapter_src_data;                          // Servo0_servo_control_slave_rsp_width_adapter:out_data -> rsp_demux_017:sink_data
	wire          servo0_servo_control_slave_rsp_width_adapter_src_ready;                         // rsp_demux_017:sink_ready -> Servo0_servo_control_slave_rsp_width_adapter:out_ready
	wire   [19:0] servo0_servo_control_slave_rsp_width_adapter_src_channel;                       // Servo0_servo_control_slave_rsp_width_adapter:out_channel -> rsp_demux_017:sink_channel
	wire          servo0_servo_control_slave_rsp_width_adapter_src_startofpacket;                 // Servo0_servo_control_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_017:sink_startofpacket
	wire          servo0_servo_control_slave_rsp_width_adapter_src_endofpacket;                   // Servo0_servo_control_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_017:sink_endofpacket
	wire          router_021_src_valid;                                                           // router_021:src_valid -> Servo1_servo_control_slave_rsp_width_adapter:in_valid
	wire   [93:0] router_021_src_data;                                                            // router_021:src_data -> Servo1_servo_control_slave_rsp_width_adapter:in_data
	wire          router_021_src_ready;                                                           // Servo1_servo_control_slave_rsp_width_adapter:in_ready -> router_021:src_ready
	wire   [19:0] router_021_src_channel;                                                         // router_021:src_channel -> Servo1_servo_control_slave_rsp_width_adapter:in_channel
	wire          router_021_src_startofpacket;                                                   // router_021:src_startofpacket -> Servo1_servo_control_slave_rsp_width_adapter:in_startofpacket
	wire          router_021_src_endofpacket;                                                     // router_021:src_endofpacket -> Servo1_servo_control_slave_rsp_width_adapter:in_endofpacket
	wire          servo1_servo_control_slave_rsp_width_adapter_src_valid;                         // Servo1_servo_control_slave_rsp_width_adapter:out_valid -> rsp_demux_018:sink_valid
	wire  [111:0] servo1_servo_control_slave_rsp_width_adapter_src_data;                          // Servo1_servo_control_slave_rsp_width_adapter:out_data -> rsp_demux_018:sink_data
	wire          servo1_servo_control_slave_rsp_width_adapter_src_ready;                         // rsp_demux_018:sink_ready -> Servo1_servo_control_slave_rsp_width_adapter:out_ready
	wire   [19:0] servo1_servo_control_slave_rsp_width_adapter_src_channel;                       // Servo1_servo_control_slave_rsp_width_adapter:out_channel -> rsp_demux_018:sink_channel
	wire          servo1_servo_control_slave_rsp_width_adapter_src_startofpacket;                 // Servo1_servo_control_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_018:sink_startofpacket
	wire          servo1_servo_control_slave_rsp_width_adapter_src_endofpacket;                   // Servo1_servo_control_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_018:sink_endofpacket
	...
	wire          cmd_mux_017_src_valid;                                                          // cmd_mux_017:src_valid -> Servo0_servo_control_slave_cmd_width_adapter:in_valid
	wire  [111:0] cmd_mux_017_src_data;                                                           // cmd_mux_017:src_data -> Servo0_servo_control_slave_cmd_width_adapter:in_data
	wire          cmd_mux_017_src_ready;                                                          // Servo0_servo_control_slave_cmd_width_adapter:in_ready -> cmd_mux_017:src_ready
	wire   [19:0] cmd_mux_017_src_channel;                                                        // cmd_mux_017:src_channel -> Servo0_servo_control_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_017_src_startofpacket;                                                  // cmd_mux_017:src_startofpacket -> Servo0_servo_control_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_017_src_endofpacket;                                                    // cmd_mux_017:src_endofpacket -> Servo0_servo_control_slave_cmd_width_adapter:in_endofpacket
	...
	wire   [19:0] servo0_servo_control_slave_cmd_width_adapter_src_channel;                       // Servo0_servo_control_slave_cmd_width_adapter:out_channel -> Servo0_servo_control_slave_burst_adapter:sink0_channel
	...
	wire          cmd_mux_018_src_valid;                                                          // cmd_mux_018:src_valid -> Servo1_servo_control_slave_cmd_width_adapter:in_valid
	wire  [111:0] cmd_mux_018_src_data;                                                           // cmd_mux_018:src_data -> Servo1_servo_control_slave_cmd_width_adapter:in_data
	wire          cmd_mux_018_src_ready;                                                          // Servo1_servo_control_slave_cmd_width_adapter:in_ready -> cmd_mux_018:src_ready
	wire   [19:0] cmd_mux_018_src_channel;                                                        // cmd_mux_018:src_channel -> Servo1_servo_control_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_018_src_startofpacket;                                                  // cmd_mux_018:src_startofpacket -> Servo1_servo_control_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_018_src_endofpacket;                                                    // cmd_mux_018:src_endofpacket -> Servo1_servo_control_slave_cmd_width_adapter:in_endofpacket
	...
	wire   [19:0] servo1_servo_control_slave_cmd_width_adapter_src_channel;                       // Servo1_servo_control_slave_cmd_width_adapter:out_channel -> Servo1_servo_control_slave_burst_adapter:sink0_channel
	...
	wire   [19:0] cmd_demux_001_src1_channel;                                                     // cmd_demux_001:src1_channel -> crosser_001:in_channel
	...
	wire   [19:0] crosser_001_out_channel;                                                        // crosser_001:out_channel -> cmd_mux_001:sink1_channel
	...
	wire   [19:0] rsp_demux_001_src0_channel;                                                     // rsp_demux_001:src0_channel -> crosser_002:in_channel
	...
	wire   [19:0] crosser_002_out_channel;                                                        // crosser_002:out_channel -> rsp_mux:sink1_channel
	...
	wire   [19:0] rsp_demux_001_src1_channel;                                                     // rsp_demux_001:src1_channel -> crosser_003:in_channel
	...
	wire   [19:0] crosser_003_out_channel;                                                        // crosser_003:out_channel -> rsp_mux_001:sink1_channel
	...
	wire          servo0_servo_control_slave_agent_rdata_fifo_src_valid;                          // Servo0_servo_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_017:in_0_valid
	wire   [17:0] servo0_servo_control_slave_agent_rdata_fifo_src_data;                           // Servo0_servo_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_017:in_0_data
	wire          servo0_servo_control_slave_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_017:in_0_ready -> Servo0_servo_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_017_out_0_valid;                                              // avalon_st_adapter_017:out_0_valid -> Servo0_servo_control_slave_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_017_out_0_data;                                               // avalon_st_adapter_017:out_0_data -> Servo0_servo_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_017_out_0_ready;                                              // Servo0_servo_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_017:out_0_ready
	wire    [0:0] avalon_st_adapter_017_out_0_error;                                              // avalon_st_adapter_017:out_0_error -> Servo0_servo_control_slave_agent:rdata_fifo_sink_error
	wire          servo1_servo_control_slave_agent_rdata_fifo_src_valid;                          // Servo1_servo_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_018:in_0_valid
	wire   [17:0] servo1_servo_control_slave_agent_rdata_fifo_src_data;                           // Servo1_servo_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_018:in_0_data
	wire          servo1_servo_control_slave_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_018:in_0_ready -> Servo1_servo_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_018_out_0_valid;                                              // avalon_st_adapter_018:out_0_valid -> Servo1_servo_control_slave_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_018_out_0_data;                                               // avalon_st_adapter_018:out_0_data -> Servo1_servo_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_018_out_0_ready;                                              // Servo1_servo_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_018:out_0_ready
	wire    [0:0] avalon_st_adapter_018_out_0_error;                                              // avalon_st_adapter_018:out_0_error -> Servo1_servo_control_slave_agent:rdata_fifo_sink_error
