...
module Computer_System_mm_interconnect_0 (
		...
		output wire [1:0]  iServo1_s1_address,                                         //                                           iServo1_s1.address
		output wire        iServo1_s1_write,                                           //                                                     .write
		input  wire [31:0] iServo1_s1_readdata,                                        //                                                     .readdata
		output wire [31:0] iServo1_s1_writedata,                                       //                                                     .writedata
		output wire        iServo1_s1_chipselect,                                      //                                                     .chipselect
	...
	wire   [31:0] iservo1_s1_agent_m0_readdata;                                                   // iServo1_s1_translator:uav_readdata -> iServo1_s1_agent:m0_readdata
	wire          iservo1_s1_agent_m0_waitrequest;                                                // iServo1_s1_translator:uav_waitrequest -> iServo1_s1_agent:m0_waitrequest
	wire          iservo1_s1_agent_m0_debugaccess;                                                // iServo1_s1_agent:m0_debugaccess -> iServo1_s1_translator:uav_debugaccess
	wire   [31:0] iservo1_s1_agent_m0_address;                                                    // iServo1_s1_agent:m0_address -> iServo1_s1_translator:uav_address
	wire    [3:0] iservo1_s1_agent_m0_byteenable;                                                 // iServo1_s1_agent:m0_byteenable -> iServo1_s1_translator:uav_byteenable
	wire          iservo1_s1_agent_m0_read;                                                       // iServo1_s1_agent:m0_read -> iServo1_s1_translator:uav_read
	wire          iservo1_s1_agent_m0_readdatavalid;                                              // iServo1_s1_translator:uav_readdatavalid -> iServo1_s1_agent:m0_readdatavalid
	wire          iservo1_s1_agent_m0_lock;                                                       // iServo1_s1_agent:m0_lock -> iServo1_s1_translator:uav_lock
	wire   [31:0] iservo1_s1_agent_m0_writedata;                                                  // iServo1_s1_agent:m0_writedata -> iServo1_s1_translator:uav_writedata
	wire          iservo1_s1_agent_m0_write;                                                      // iServo1_s1_agent:m0_write -> iServo1_s1_translator:uav_write
	wire    [2:0] iservo1_s1_agent_m0_burstcount;                                                 // iServo1_s1_agent:m0_burstcount -> iServo1_s1_translator:uav_burstcount
	wire          iservo1_s1_agent_rf_source_valid;                                               // iServo1_s1_agent:rf_source_valid -> iServo1_s1_agent_rsp_fifo:in_valid
	wire  [112:0] iservo1_s1_agent_rf_source_data;                                                // iServo1_s1_agent:rf_source_data -> iServo1_s1_agent_rsp_fifo:in_data
	wire          iservo1_s1_agent_rf_source_ready;                                               // iServo1_s1_agent_rsp_fifo:in_ready -> iServo1_s1_agent:rf_source_ready
	wire          iservo1_s1_agent_rf_source_startofpacket;                                       // iServo1_s1_agent:rf_source_startofpacket -> iServo1_s1_agent_rsp_fifo:in_startofpacket
	wire          iservo1_s1_agent_rf_source_endofpacket;                                         // iServo1_s1_agent:rf_source_endofpacket -> iServo1_s1_agent_rsp_fifo:in_endofpacket
	wire          iservo1_s1_agent_rsp_fifo_out_valid;                                            // iServo1_s1_agent_rsp_fifo:out_valid -> iServo1_s1_agent:rf_sink_valid
	wire  [112:0] iservo1_s1_agent_rsp_fifo_out_data;                                             // iServo1_s1_agent_rsp_fifo:out_data -> iServo1_s1_agent:rf_sink_data
	wire          iservo1_s1_agent_rsp_fifo_out_ready;                                            // iServo1_s1_agent:rf_sink_ready -> iServo1_s1_agent_rsp_fifo:out_ready
	wire          iservo1_s1_agent_rsp_fifo_out_startofpacket;                                    // iServo1_s1_agent_rsp_fifo:out_startofpacket -> iServo1_s1_agent:rf_sink_startofpacket
	wire          iservo1_s1_agent_rsp_fifo_out_endofpacket;                                      // iServo1_s1_agent_rsp_fifo:out_endofpacket -> iServo1_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_019_src_valid;                                                          // cmd_mux_019:src_valid -> iServo1_s1_agent:cp_valid
	wire  [111:0] cmd_mux_019_src_data;                                                           // cmd_mux_019:src_data -> iServo1_s1_agent:cp_data
	wire          cmd_mux_019_src_ready;                                                          // iServo1_s1_agent:cp_ready -> cmd_mux_019:src_ready
	wire   [22:0] cmd_mux_019_src_channel;                                                        // cmd_mux_019:src_channel -> iServo1_s1_agent:cp_channel
	wire          cmd_mux_019_src_startofpacket;                                                  // cmd_mux_019:src_startofpacket -> iServo1_s1_agent:cp_startofpacket
	wire          cmd_mux_019_src_endofpacket;                                                    // cmd_mux_019:src_endofpacket -> iServo1_s1_agent:cp_endofpacket
	...
	wire          iservo1_s1_agent_rp_valid;                                                      // iServo1_s1_agent:rp_valid -> router_022:sink_valid
	wire  [111:0] iservo1_s1_agent_rp_data;                                                       // iServo1_s1_agent:rp_data -> router_022:sink_data
	wire          iservo1_s1_agent_rp_ready;                                                      // router_022:sink_ready -> iServo1_s1_agent:rp_ready
	wire          iservo1_s1_agent_rp_startofpacket;                                              // iServo1_s1_agent:rp_startofpacket -> router_022:sink_startofpacket
	wire          iservo1_s1_agent_rp_endofpacket;                                                // iServo1_s1_agent:rp_endofpacket -> router_022:sink_endofpacket
	...
	wire          iservo1_s1_agent_rdata_fifo_src_valid;                                          // iServo1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_019:in_0_valid
	wire   [33:0] iservo1_s1_agent_rdata_fifo_src_data;                                           // iServo1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_019:in_0_data
	wire          iservo1_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_019:in_0_ready -> iServo1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_019_out_0_valid;                                              // avalon_st_adapter_019:out_0_valid -> iServo1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_019_out_0_data;                                               // avalon_st_adapter_019:out_0_data -> iServo1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_019_out_0_ready;                                              // iServo1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_019:out_0_ready
	wire    [0:0] avalon_st_adapter_019_out_0_error;                                              // avalon_st_adapter_019:out_0_error -> iServo1_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) iservo1_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                //                      clk.clk
		.reset                  (ADC_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (iservo1_s1_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (iservo1_s1_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (iservo1_s1_agent_m0_read),              //                         .read
		.uav_write              (iservo1_s1_agent_m0_write),             //                         .write
		.uav_waitrequest        (iservo1_s1_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (iservo1_s1_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (iservo1_s1_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (iservo1_s1_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (iservo1_s1_agent_m0_writedata),         //                         .writedata
		.uav_lock               (iservo1_s1_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (iservo1_s1_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (iServo1_s1_address),                    //      avalon_anti_slave_0.address
		.av_write               (iServo1_s1_write),                      //                         .write
		.av_readdata            (iServo1_s1_readdata),                   //                         .readdata
		.av_writedata           (iServo1_s1_writedata),                  //                         .writedata
		.av_chipselect          (iServo1_s1_chipselect),                 //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                      //             clk.clk
		.reset                   (ADC_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (iservo1_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (iservo1_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (iservo1_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (iservo1_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (iservo1_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (iservo1_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (iservo1_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (iservo1_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (iservo1_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (iservo1_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (iservo1_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (iservo1_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (iservo1_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (iservo1_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (iservo1_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (iservo1_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (iservo1_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (iservo1_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (iservo1_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (iservo1_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (iservo1_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (iservo1_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (iservo1_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (iservo1_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (iservo1_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (iservo1_s1_agent_rf_source_data),             //                .data
		...
		.rdata_fifo_src_ready    (iservo1_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (iservo1_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (iservo1_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) iservo1_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (ADC_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (iservo1_s1_agent_rf_source_data),             //        in.data
		.in_valid          (iservo1_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (iservo1_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (iservo1_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (iservo1_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (iservo1_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (iservo1_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (iservo1_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (iservo1_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (iservo1_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	Computer_System_mm_interconnect_0_router_003 router_022 (
		.sink_ready         (iservo1_s1_agent_rp_ready),             //      sink.ready
		.sink_valid         (iservo1_s1_agent_rp_valid),             //          .valid
		.sink_data          (iservo1_s1_agent_rp_data),              //          .data
		.sink_startofpacket (iservo1_s1_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (iservo1_s1_agent_rp_endofpacket),       //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                //       clk.clk
		.reset              (ADC_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                // in_clk_0.clk
		.in_rst_0_reset (ADC_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (iservo1_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (iservo1_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (iservo1_s1_agent_rdata_fifo_src_ready), //         .ready
