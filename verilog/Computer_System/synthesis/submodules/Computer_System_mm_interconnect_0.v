...
module Computer_System_mm_interconnect_0 (
	...
	wire   [18:0] cmd_mux_src_channel;                                                           // cmd_mux:src_channel -> ADC_adc_slave_agent:cp_channel
	...
	wire   [18:0] cmd_mux_003_src_channel;                                                       // cmd_mux_003:src_channel -> Nios2_debug_mem_slave_agent:cp_channel
	...
	wire   [18:0] cmd_mux_005_src_channel;                                                       // cmd_mux_005:src_channel -> Onchip_SRAM_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_006_src_channel;                                                       // cmd_mux_006:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_007_src_channel;                                                       // cmd_mux_007:src_channel -> HEX3_HEX0_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_008_src_channel;                                                       // cmd_mux_008:src_channel -> HEX5_HEX4_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_009_src_channel;                                                       // cmd_mux_009:src_channel -> Slider_Switches_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_010_src_channel;                                                       // cmd_mux_010:src_channel -> Pushbuttons_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_011_src_channel;                                                       // cmd_mux_011:src_channel -> Expansion_JP1_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_012_src_channel;                                                       // cmd_mux_012:src_channel -> Arduino_GPIO_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_013_src_channel;                                                       // cmd_mux_013:src_channel -> Arduino_Reset_N_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_014_src_channel;                                                       // cmd_mux_014:src_channel -> Interval_Timer_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_015_src_channel;                                                       // cmd_mux_015:src_channel -> Interval_Timer_2_s1_agent:cp_channel
	...
	wire          servo0_servo_control_slave_agent_rp_valid;                                     // Servo0_servo_control_slave_agent:rp_valid -> router_019:sink_valid
	wire   [93:0] servo0_servo_control_slave_agent_rp_data;                                      // Servo0_servo_control_slave_agent:rp_data -> router_019:sink_data
	wire          servo0_servo_control_slave_agent_rp_ready;                                     // router_019:sink_ready -> Servo0_servo_control_slave_agent:rp_ready
	wire          servo0_servo_control_slave_agent_rp_startofpacket;                             // Servo0_servo_control_slave_agent:rp_startofpacket -> router_019:sink_startofpacket
	wire          servo0_servo_control_slave_agent_rp_endofpacket;                               // Servo0_servo_control_slave_agent:rp_endofpacket -> router_019:sink_endofpacket
	wire          servo1_servo_control_slave_agent_rp_valid;                                     // Servo1_servo_control_slave_agent:rp_valid -> router_020:sink_valid
	wire   [93:0] servo1_servo_control_slave_agent_rp_data;                                      // Servo1_servo_control_slave_agent:rp_data -> router_020:sink_data
	wire          servo1_servo_control_slave_agent_rp_ready;                                     // router_020:sink_ready -> Servo1_servo_control_slave_agent:rp_ready
	wire          servo1_servo_control_slave_agent_rp_startofpacket;                             // Servo1_servo_control_slave_agent:rp_startofpacket -> router_020:sink_startofpacket
	wire          servo1_servo_control_slave_agent_rp_endofpacket;                               // Servo1_servo_control_slave_agent:rp_endofpacket -> router_020:sink_endofpacket
	...
	wire   [18:0] servo0_servo_control_slave_burst_adapter_source0_channel;                      // Servo0_servo_control_slave_burst_adapter:source0_channel -> Servo0_servo_control_slave_agent:cp_channel
	...
	wire   [18:0] servo1_servo_control_slave_burst_adapter_source0_channel;                      // Servo1_servo_control_slave_burst_adapter:source0_channel -> Servo1_servo_control_slave_agent:cp_channel
	...
	wire   [18:0] cmd_demux_002_src0_channel;                                                    // cmd_demux_002:src0_channel -> cmd_mux_003:sink1_channel
	...
	wire   [18:0] cmd_demux_002_src1_channel;                                                    // cmd_demux_002:src1_channel -> cmd_mux_004:sink2_channel
	...
	wire   [18:0] rsp_demux_003_src1_channel;                                                    // rsp_demux_003:src1_channel -> rsp_mux_002:sink0_channel
	...
	wire   [18:0] rsp_demux_004_src2_channel;                                                    // rsp_demux_004:src2_channel -> rsp_mux_002:sink1_channel
	...
	wire          router_019_src_valid;                                                          // router_019:src_valid -> Servo0_servo_control_slave_rsp_width_adapter:in_valid
	wire   [93:0] router_019_src_data;                                                           // router_019:src_data -> Servo0_servo_control_slave_rsp_width_adapter:in_data
	wire          router_019_src_ready;                                                          // Servo0_servo_control_slave_rsp_width_adapter:in_ready -> router_019:src_ready
	wire   [18:0] router_019_src_channel;                                                        // router_019:src_channel -> Servo0_servo_control_slave_rsp_width_adapter:in_channel
	wire          router_019_src_startofpacket;                                                  // router_019:src_startofpacket -> Servo0_servo_control_slave_rsp_width_adapter:in_startofpacket
	wire          router_019_src_endofpacket;                                                    // router_019:src_endofpacket -> Servo0_servo_control_slave_rsp_width_adapter:in_endofpacket
	wire          servo0_servo_control_slave_rsp_width_adapter_src_valid;                        // Servo0_servo_control_slave_rsp_width_adapter:out_valid -> rsp_demux_016:sink_valid
	wire  [111:0] servo0_servo_control_slave_rsp_width_adapter_src_data;                         // Servo0_servo_control_slave_rsp_width_adapter:out_data -> rsp_demux_016:sink_data
	wire          servo0_servo_control_slave_rsp_width_adapter_src_ready;                        // rsp_demux_016:sink_ready -> Servo0_servo_control_slave_rsp_width_adapter:out_ready
	wire   [18:0] servo0_servo_control_slave_rsp_width_adapter_src_channel;                      // Servo0_servo_control_slave_rsp_width_adapter:out_channel -> rsp_demux_016:sink_channel
	wire          servo0_servo_control_slave_rsp_width_adapter_src_startofpacket;                // Servo0_servo_control_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_016:sink_startofpacket
	wire          servo0_servo_control_slave_rsp_width_adapter_src_endofpacket;                  // Servo0_servo_control_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_016:sink_endofpacket
	wire          router_020_src_valid;                                                          // router_020:src_valid -> Servo1_servo_control_slave_rsp_width_adapter:in_valid
	wire   [93:0] router_020_src_data;                                                           // router_020:src_data -> Servo1_servo_control_slave_rsp_width_adapter:in_data
	wire          router_020_src_ready;                                                          // Servo1_servo_control_slave_rsp_width_adapter:in_ready -> router_020:src_ready
	wire   [18:0] router_020_src_channel;                                                        // router_020:src_channel -> Servo1_servo_control_slave_rsp_width_adapter:in_channel
	wire          router_020_src_startofpacket;                                                  // router_020:src_startofpacket -> Servo1_servo_control_slave_rsp_width_adapter:in_startofpacket
	wire          router_020_src_endofpacket;                                                    // router_020:src_endofpacket -> Servo1_servo_control_slave_rsp_width_adapter:in_endofpacket
	wire          servo1_servo_control_slave_rsp_width_adapter_src_valid;                        // Servo1_servo_control_slave_rsp_width_adapter:out_valid -> rsp_demux_017:sink_valid
	wire  [111:0] servo1_servo_control_slave_rsp_width_adapter_src_data;                         // Servo1_servo_control_slave_rsp_width_adapter:out_data -> rsp_demux_017:sink_data
	wire          servo1_servo_control_slave_rsp_width_adapter_src_ready;                        // rsp_demux_017:sink_ready -> Servo1_servo_control_slave_rsp_width_adapter:out_ready
	wire   [18:0] servo1_servo_control_slave_rsp_width_adapter_src_channel;                      // Servo1_servo_control_slave_rsp_width_adapter:out_channel -> rsp_demux_017:sink_channel
	wire          servo1_servo_control_slave_rsp_width_adapter_src_startofpacket;                // Servo1_servo_control_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_017:sink_startofpacket
	wire          servo1_servo_control_slave_rsp_width_adapter_src_endofpacket;                  // Servo1_servo_control_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_017:sink_endofpacket
	...
	wire          cmd_mux_016_src_valid;                                                         // cmd_mux_016:src_valid -> Servo0_servo_control_slave_cmd_width_adapter:in_valid
	wire  [111:0] cmd_mux_016_src_data;                                                          // cmd_mux_016:src_data -> Servo0_servo_control_slave_cmd_width_adapter:in_data
	wire          cmd_mux_016_src_ready;                                                         // Servo0_servo_control_slave_cmd_width_adapter:in_ready -> cmd_mux_016:src_ready
	wire   [18:0] cmd_mux_016_src_channel;                                                       // cmd_mux_016:src_channel -> Servo0_servo_control_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_016_src_startofpacket;                                                 // cmd_mux_016:src_startofpacket -> Servo0_servo_control_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                   // cmd_mux_016:src_endofpacket -> Servo0_servo_control_slave_cmd_width_adapter:in_endofpacket
	...
	wire   [18:0] servo0_servo_control_slave_cmd_width_adapter_src_channel;                      // Servo0_servo_control_slave_cmd_width_adapter:out_channel -> Servo0_servo_control_slave_burst_adapter:sink0_channel
	...
	wire          cmd_mux_017_src_valid;                                                         // cmd_mux_017:src_valid -> Servo1_servo_control_slave_cmd_width_adapter:in_valid
	wire  [111:0] cmd_mux_017_src_data;                                                          // cmd_mux_017:src_data -> Servo1_servo_control_slave_cmd_width_adapter:in_data
	wire          cmd_mux_017_src_ready;                                                         // Servo1_servo_control_slave_cmd_width_adapter:in_ready -> cmd_mux_017:src_ready
	wire   [18:0] cmd_mux_017_src_channel;                                                       // cmd_mux_017:src_channel -> Servo1_servo_control_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_017_src_startofpacket;                                                 // cmd_mux_017:src_startofpacket -> Servo1_servo_control_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_017_src_endofpacket;                                                   // cmd_mux_017:src_endofpacket -> Servo1_servo_control_slave_cmd_width_adapter:in_endofpacket
	...
	wire   [18:0] servo1_servo_control_slave_cmd_width_adapter_src_channel;                      // Servo1_servo_control_slave_cmd_width_adapter:out_channel -> Servo1_servo_control_slave_burst_adapter:sink0_channel
	...
	wire          servo0_servo_control_slave_agent_rdata_fifo_src_valid;                         // Servo0_servo_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [17:0] servo0_servo_control_slave_agent_rdata_fifo_src_data;                          // Servo0_servo_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          servo0_servo_control_slave_agent_rdata_fifo_src_ready;                         // avalon_st_adapter_016:in_0_ready -> Servo0_servo_control_slave_agent:rdata_fifo_src_ready
	...
	wire          servo1_servo_control_slave_agent_rdata_fifo_src_valid;                         // Servo1_servo_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_017:in_0_valid
	wire   [17:0] servo1_servo_control_slave_agent_rdata_fifo_src_data;                          // Servo1_servo_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_017:in_0_data
	wire          servo1_servo_control_slave_agent_rdata_fifo_src_ready;                         // avalon_st_adapter_017:in_0_ready -> Servo1_servo_control_slave_agent:rdata_fifo_src_ready
	...
	Computer_System_mm_interconnect_0_router_019 router_019 (
	...
	Computer_System_mm_interconnect_0_router_019 router_020 (
